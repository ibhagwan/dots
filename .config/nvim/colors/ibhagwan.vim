...
let g:colors_name = "ibhagwan"

"}}}
" Vim UI {{{
hi Normal              ctermfg=7
hi Cursor              ctermfg=7     ctermbg=1
"hi CursorLine          ctermbg=12    cterm=NONE
...
hi StatusLineNC        ctermfg=8     ctermbg=4     cterm=bold
hi VertSplit           ctermfg=13    ctermbg=NONE  cterm=bold
hi TabLine             ctermfg=8     ctermbg=4     cterm=bold
...
hi DiffAdd             ctermfg=7     ctermbg=12    cterm=bold
hi DiffChange          ctermfg=0     ctermbg=3
hi DiffDelete          ctermfg=0     ctermbg=1
hi DiffText            ctermfg=6     ctermbg=11    cterm=bold
