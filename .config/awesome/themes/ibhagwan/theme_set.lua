...
local lain_icons = config_path .. "/awesome/lain/icons/layout/default/"

local theme = {
    set_theme = function(self, cs, config)
        ...
        -- Notifiy font
        self.notify_font_name = config.notify_font or "Monospace"
        self.notify_font_size = self.font_size
        self.notification_font = self.notify_font_name .. " " .. (self.notify_font_size)
        ...
        self.tasklist_font_name = config.tasklist_font or self.font_name
        self.tasklist_font_size = dpi(4.5)
        self.tasklist_font = self.tasklist_font_name .. " " .. (self.tasklist_font_size)


        --self.tasklist_plain_task_name = true
        local gap = config.gap or 2
        self.tasklist_disable_icon = true
        self.gap_single_client = true
        self.useless_gap = dpi(gap)
        ...
        self.border_normal = cs.bg
        self.border_focus = cs.colors[4]
        self.border_marked = cs.colors[5]
        ...
        self.notification_bg = cs.bg
        self.notification_fg = cs.fg
        ...
        self.widget_colors = {
            ...
            netup = cs.colors[3],
            volume = cs.colors[4],
            vol_main = cs.colors[5],
            vol_mute = cs.colors[10],
            memory = cs.colors[5],
            cpu = cs.colors[5],
            fs = cs.colors[7],
